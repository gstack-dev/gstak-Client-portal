// components/web/GoogleSignInButton.tsx
"use client";

import { Button } from "@/components/ui/button";
import { loginWithGoogle } from "@/app/actions/auth"; // Import the server action

export default function GoogleSignInButton() {
    return (
        <div className="mt-lg">
            {/* The action prop securely calls the server function */}
            <form action={loginWithGoogle}>
                ...
                >
                    <svg className="w-5 h-5 mr-sm" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
