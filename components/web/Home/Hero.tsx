  ...
  return (
    <section className="px-4 md:px-12 max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center py-16">
      <div className="flex flex-col gap-4">
        ...
        >
          Manage Your Projects Without Endless Messages
        </h1>
        <p className="text-lg text-slate-500 dark:text-slate-400 max-w-[512px] leading-relaxed">
          A highly organized workspace to track progress, share files securely,
          and keep your clients informed in real-time. Experience engineered
          quality for digital agencies.
        </p>
